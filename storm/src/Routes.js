...
export default function Routes({ appProps }) {
  return (
    <Switch>
      ...
      <AppliedRoute Route exact path="/admin/candidates" component={(props) => <Candidates {...props}/>}/>
      ...
      <AppliedRoute path="/admin/candidates/add" exact component={AddCandidate} appProps={appProps} />
